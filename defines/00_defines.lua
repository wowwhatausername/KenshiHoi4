...
NGame = {
	START_DATE = "7988.1.1.12",
	END_DATE = "8000.1.1.1",
	MAP_SCALE_PIXEL_TO_KM = 0.1,					-- Yes, we did the math
	...
	HANDS_OFF_START_TAG = "FIS",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
	ALERT_SFX_COOLDOWN_DAYS = 1,					-- After playing an alert sound, don't play the same sound for XXX days, even if it fires again.
},

NDiplomacy = {
	DIPLOMACY_REQUEST_EXPIRY_DAYS = 30,
	BASE_SURRENDER_LEVEL = 0.8,						-- Surrender when level reached. valid 0-1
	...
	BASE_IMPROVE_RELATION_COST = 40,                -- Political power cost to initiate relation improvement
	BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 1.6, -- Political power cost each update when boosting relations with nation of same ideology
	BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 2.0,    -- Political power cost each update when boosting relations with nation of different ideology
	...
	BASE_GENERATE_WARGOAL_DAILY_PP = 2,	-- Daily pp cost for generation of wargoals
	...
	BASE_STAGE_COUP_DAILY_PP = 10,					-- Daily pp cost for staging a coup
	BASE_STAGE_COUP_TOTAL_COST = 100, 				-- Equipment consume factor for stage coup.
	...
	IC_TO_EQUIPMENT_COUP_RATIO = 0.07,				-- Ratio for calculating cost of staging coup
	...
	TENSION_STATE_VALUE = 1.5,						-- Tension value gained by annexing one state
	...
	TENSION_DECAY_DAILY = 0.002,					-- Each day tension decays this much for Threat sources which are no longer relevant. Replaces TENSION_DECAY as of 1.12.0
...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.115,			-- basic population growth per year, used for monthly manpower gain
	...
	BASE_STABILITY_WAR_FACTOR = -0.4,				-- Default stability war factor
	...
	MAJOR_MIN_FACTORIES = 20,						-- need at least these many factories to become a major
	...
	VICTORY_POINTS_IMPORTANCE_FACTOR = 5.5,			-- State victory points importance factor for AI and calculations
	BUILDING_IMPORTANCE_FACTOR = 3.0,				-- State building importance factor for AI and calculations
	RESOURCE_IMPORTANCE_FACTOR = 1.5,				-- State resource importance factor for AI and calculations
	...
	POLITICAL_POWER_LOWER_CAP = -99999.0,				-- Min amount of political power country should have
	POLITICAL_POWER_UPPER_CAP = 99999.0,				-- Max amount of political power country should have
	...
	SURRENDER_LIMIT_MULT_FOR_COUNTRIES_WITH_NO_CORES = 0.5, -- Countries with no owned cores will their surrender level multiplied by this amount
	...
	WAR_SUPPORT_FROM_CASUALTIES = 0.035,							-- Base value (inverted) for calculating heroes being killed
	...
	DAYS_OF_WAR_BEFORE_SURRENDER = 1,				-- Number of days a war has to have existed before anyone can surrender in it

	FUEL_LEASE_CONVOY_RATIO = 0.0005,				-- num convoys needed per fuel land lease

	STARTING_FUEL_RATIO = 0.2,						-- starting fuel ratio compared to max fuel for countries
	...
	SCORCHED_EARTH_STATE_COST = 20,					-- pp cost to scorch a state
...
NResistance = {
	...
	RESISTANCE_TARGET_MODIFIER_IS_AT_PEACE = 0.0,			-- resistance target modifier when we are at peace
	...
	RESISTANCE_POP_LOW_CUTOFF = 800,
	RESISTANCE_POP_VERY_LOW_CUTOFF = 200,
	...
	RESISTANCE_DECAY_BASE = 0.5, -- base resistance decay
	...
	RESISTANCE_GROWTH_BASE = 0.5, -- base resistance grow
	RESISTANCE_GROWTH_MIN = 0.01, -- min resistance grow
	RESISTANCE_GROWTH_MAX = 100.0, -- max resistance grow

	COMPLIANCE_GROWTH_BASE = 0.25, -- base compliance grow
	...
	RESISTANCE_ACTIVITY_CHANCE_AT_MAX_RESISTANCE = 0.05,
	...
	STATE_COMPLIANCE_DECAY_FOR_LOST_STATES = 0.1, -- daily compliance decay for the states you lost control of
...
NProduction = {
	...
	ANNEX_FUEL_RATIO = 0.70,	-- How much fuel will be transferred on annexation
	ANNEX_CONVOYS_RATIO = 0.3,			-- How many convoys will be transferred on annexation
...
NPolitics = {
	...
	ARMY_LEADER_COST = 10,					-- command power cost for recruiting new leaders, 'this value' * number_of_existing_leaders_of_type
...
NBuildings = {
	...
	BASE_FACTORY_REPAIR = 0.1,			-- Default repair rate before factories are taken into account
...
NMilitary = {
	...
	INFRA_ORG_IMPACT = 0.25,				-- scale factor of infra on org regain.
	...
	WAR_SCORE_LOSSES_MULT_IF_CAPITULATED = 0.5, 				-- factor applied to war score gained from casualties if capitulated
	...
	DIVISION_SIZE_FOR_XP = 6,                   -- how many battalions should a division have to count as a full divisions when calculating XP stuff
	...
	MAX_NAVY_EXPERIENCE = 1,			--Max navy experience a country can store
	MAX_AIR_EXPERIENCE = 1,				--Max air experience a country can store
	...
	COMBAT_MOVEMENT_SPEED = 0.15,	               -- speed reduction base modifier in combat
	...
	MULTIPLE_COMBATS_PENALTY = -0.75,               -- defender penalty if attacked from multiple directions
	...
	UNIT_DIGIN_CAP = 0,                           -- how "deep" you can dig you can dig in until hitting max bonus
	...
	SUPPLY_GRACE = 24,							   -- troops always carry 3 days of food and supply
	...
	SUPPLY_ORG_MAX_CAP = 0.10,                     -- Max organization is factored by this if completely out of supply
	MAX_OUT_OF_SUPPLY_DAYS = 30, 				   -- how many days of shitty supply until max penalty achieved
	OUT_OF_SUPPLY_ATTRITION = 0.75,                 -- max attrition when out of supply
	...
	OUT_OF_SUPPLY_MORALE = -0.8,                   -- max org regain reduction from supply
	...
	REINFORCE_CHANCE = 0.05,                 	   -- base chance to join combat from back line when empty
	...
	CIVILWAR_ORGANIZATION_FACTOR = 0.75,			  	-- Multiplier of org for both sides when civilwar.
	...
	PROMOTE_LEADER_CP_COST = 100.0,					-- cost of promoting a leader
	...
	FUEL_PENALTY_START_RATIO = 0.1,				-- ratio of fuel in an army to start getting penalties
	...
	ARMY_STRATEGIC_DEPLOYMENT_FUEL_MULT = 1.0,		-- fuel consumption ratio while doing strategic deployment
...
NAir = {
	...
	COMBAT_DAMAGE_SCALE = 0.5,							-- Higher value = more shot down planes
...
NNavy = {
	...
	CAPITAL_RATIO_FOR_FULL_SCREENING_FOR_CONVOYS 					= 0.25,  -- this capital ratio to num carriers is needed for full screening beyond screen line
...
NTrade = {
	DISTANCE_TRADE_FACTOR = -0.04,				-- Trade factor is modified by distance times this
...
NAI = {
	...
	BASE_DISTANCE_TO_CARE = 400.0,				-- Countries that are too far away are less interesting in diplomacy
	...
	WANTED_UNITS_MANPOWER_DIVISOR = 2000,                       -- Normalizing divisor for AI manpower. (for each x max available manpower, they want one division)
	...
	WANTED_UNITS_MAX_WANTED_CAP = 200,	-- Maximum wanted divisions for a country. This can be exceeded by certain hardcoded multipliers, but not by base calculation logic.
	...
	MAX_PP_TO_SPEND_ON_LOWER_PRIO_TASKS = 50,			-- max pp cost for ai to allow spend pp on lower prio things while a higher prio things are available
	...
	FAILED_INVASION_AVOID_DURATION = 90,                   -- after a failed invasion, AI will down-prioritize invading the same area again for this number of days
